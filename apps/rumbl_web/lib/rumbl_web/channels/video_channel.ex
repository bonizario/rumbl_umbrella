defmodule RumblWeb.VideoChannel do
  ...
  @spec join(String.t(), map(), Socket.t()) :: {:ok, %{annotations: list()}, Socket.t()}
  ...
  @spec handle_in(String.t(), map(), Socket.t()) :: {:reply, :ok | {:error, map()}, Socket.t()}
  def handle_in(event, params, socket) do
    user = Accounts.get_user!(socket.assigns.user_id)
    handle_in(event, params, user, socket)
  end

  @spec handle_in(String.t(), map(), User.t(), Socket.t()) ::
          {:reply, :ok | {:error, map()}, Socket.t()}
